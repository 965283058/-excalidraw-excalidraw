...
var labels = {
  ...
  copySource: "Kopier kilde til utklippstavle",
  convertToCode: "Konverter til kode",
  ...
  stroke: "Strek",
  changeStroke: "Endre farge p\xE5 omriss",
  background: "Bakgrunn",
  changeBackground: "Endre bakgrunnsfarge",
  fill: "Fyll",
  ...
  arrowhead_circle: "Sirkel",
  arrowhead_circle_outline: "Sirkel (omriss)",
  arrowhead_triangle: "Trekant",
  arrowhead_triangle_outline: "Trekant (omriss)",
  arrowhead_diamond: "Diamant",
  arrowhead_diamond_outline: "Diamant (omriss)",
  arrowhead_crowfoot_many: "Kr\xE5kefot (mange)",
  arrowhead_crowfoot_one: "Kr\xE5kefot (\xE9n)",
  arrowhead_crowfoot_one_or_many: "Kr\xE5kefot (\xE9n eller mange)",
  ...
  showFonts: "Vis skriftvelger",
  toggleTheme: "Vis/skjul lys/m\xF8rkt tema",
  theme: "Tema",
  ...
  link: {
    edit: "Rediger lenke",
    editEmbed: "Rediger innebyggbar lenke",
    create: "Legg til lenke",
    label: "Lenke",
    labelEmbed: "Lenk & bygg inn",
    empty: "Ingen lenke er valgt",
    hint: "Skriv eller lim inn lenken din her",
    goToElement: "G\xE5 til m\xE5lelement"
  },
  lineEditor: {
    edit: "Rediger linje",
    editArrow: "Rediger pil"
  },
  polygon: {
    breakPolygon: "",
    convertToPolygon: ""
  ...
  prompt: "Tekst",
  followUs: "F\xF8lg oss",
  discordChat: "Discord-chat",
  zoomToFitViewport: "Zoom for \xE5 f\xE5 plass i visning",
  zoomToFitSelection: "Zoom for \xE5 passe utvalg",
  zoomToFit: "Zoom for \xE5 se alle elementer",
  installPWA: "Installer Excalidraw lokalt (PWA)",
  autoResize: "Aktiver automatisk endring av tekstst\xF8rrelse",
  imageCropping: "Bildebeskj\xE6ring",
  unCroppedDimension: "Ikke-besk\xE5ret dimensjon",
  copyElementLink: "Kopier lenke til objekt",
...
var elementLink = {
  ...
  desc: "Klikk p\xE5 en figur p\xE5 lerretet eller lim inn en lenke.",
  notFound: "Koblet objekt ble ikke funnet p\xE5 lerretet."
};
var library = {
...
var buttons = {
  ...
  zenMode: "Zen-modus",
  objectsSnapMode: "Fest til elementer",
...
var errors = {
  ...
  failedToFetchImage: "Kunne ikke hente bilde.",
  ...
  saveLibraryError: "Kunne ikke lagre biblioteket ditt. Vennligst lagre biblioteket til en fil lokalt for \xE5 sikre at du ikke mister endringer.",
  ...
  imageToolNotSupported: "Bilder er deaktivert.",
  ...
  libraryElementTypeError: {
    ...
    iframe: "IFrame-elementer kan ikke legges til i biblioteket.",
    image: "St\xF8tte for \xE5 legge til bilder i biblioteket kommer snart!"
  },
  asyncPasteFailedOnRead: "Kunne ikke lime inn (kunne ikke lese fra systemets utklippstavle).",
  asyncPasteFailedOnParse: "Kunne ikke lime inn.",
  copyToSystemClipboardFailed: "Kunne ikke kopiere til utklippstavlen."
};
var toolBar = {
  selection: "Velg",
  lasso: "",
  ...
  link: "Legg til / oppdater lenke for en valgt figur",
  eraser: "Viskel\xE6r",
...
var roomDialog = {
  desc_intro: "Inviter folk til \xE5 samarbeide om tegningen din.",
  desc_privacy: "Ikke bekymre deg, \xF8kten er ende-til-ende kryptert og fullt privat. Ikke engang v\xE5r server kan se hva du tegner.",
...
var helpDialog = {
  ...
  createFlowchart: "Lag et flytdiagram ut fra et generisk element",
  navigateFlowchart: "Naviger et flytdiagram",
  ...
  cropStart: "Beskj\xE6r bilde",
  cropFinish: "Fullf\xF8r bildebeskj\xE6ring"
};
...
var stats = {
  ...
  selected: "Valgt",
  storage: "Lagring",
  fullTitle: "Lerret- og formegenskaper",
  title: "Egenskaper",
  generalStats: "Generelt",
  elementProperties: "Egenskaper for form",
  total: "Totalt",
  version: "Versjon",
...
var toast = {
  ...
  copyToClipboardAsSvg: "Kopierte {{exportSelection}} til utklippstavlen som SVG\n({{exportColorScheme}})",
  ...
  elementLinkCopied: "Lenke kopiert til utklippstavlen"
};
var colors = {
...
var mermaid = {
  ...
  button: "Sett inn",
  description: "Forel\xF8pig er bare <flowchartLink>Flowchart</flowchartLink>-,<sequenceLink> Sequence</sequenceLink>- og <classLink>klasse </classLink>-diagrammer st\xF8ttet. De andre typene vil bli gjengitt som bilde i Excalidraw.",
  syntax: "Mermaid-syntaks",
  preview: "Forh\xE5ndsvisning"
};
var quickSearch = {
  placeholder: "Hurtigs\xF8k"
};
var fontList = {
  badge: {
    old: "gammel"
  },
  sceneFonts: "I denne scenen",
  availableFonts: "Tilgjengelige skrifttyper",
  empty: "Ingen skrifttyper funnet"
};
var userList = {
  empty: "Ingen brukere funnet",
  hint: {
    text: "Klikk p\xE5 en bruker for \xE5 f\xF8lge",
    followStatus: "Du f\xF8lger denne brukeren",
    inCall: "Brukeren er i et taleanrop",
    micMuted: "Brukerens mikrofon er dempet",
    isSpeaking: "Bruker snakker"
  }
};
var commandPalette = {
  ...
  recents: "Nylig brukt",
  search: {
    placeholder: "S\xF8k etter menyer, kommandoer og oppdag skjulte skatter",
    noMatch: "Ingen treff for kommandoer..."
  },
  itemNotAvailable: "Kommandoen er ikke tilgjengelig...",
  shortcutHint: "For kommandopalett, bruk {{shortcut}}"
};
var keys = {
  ctrl: "",
  option: "",
...
//# sourceMappingURL=nb-NO-7YZHFFVS.js.map
