...
var labels = {
  ...
  changeBackground: "Changer la couleur d'arri\xE8re-plan",
  fill: "Remplissage",
  ...
  arrowtypes: "Type de fl\xE8che",
  arrowtype_sharp: "Fl\xE8che pointue",
  arrowtype_round: "Fl\xE8che incurv\xE9e",
  arrowtype_elbowed: "Fl\xE8che coud\xE9e",
  ...
  loadScene: "Charger une sc\xE8ne depuis un fichier",
  align: "Alignement",
  ...
  showFonts: "Afficher le s\xE9lecteur de polices",
  ...
  zoomToFitViewport: "Zoomer pour tenir dans la fen\xEAtre d'affichage",
  zoomToFitSelection: "Zoomer pour s'adapter \xE0 la s\xE9lection",
  ...
  unCroppedDimension: "Dimension non recadr\xE9e",
  copyElementLink: "Copier le lien vers un objet",
  linkToElement: "Lien vers un objet",
  wrapSelectionInFrame: "Mettre la s\xE9lection dans un cadre",
  tab: "Onglet",
...
var elementLink = {
  ...
  notFound: "L'objet li\xE9 n'a pas \xE9t\xE9 trouv\xE9 sur le canvas."
};
var library = {
  ...
  search: {
    inputPlaceholder: "Rechercher dans la biblioth\xE8que",
    heading: "Correspondance de la biblioth\xE8que",
    noResults: "Aucun \xE9l\xE9ment correspondant trouv\xE9...",
    clearSearch: "Effacer la recherche"
  }
};
var search = {
  title: "Rechercher sur le canevas",
  noMatch: "Aucun r\xE9sultat trouv\xE9...",
  singleResult: "r\xE9sultat",
  multipleResults: "r\xE9sultats",
...
var alerts = {
  ...
  localStorageQuotaExceeded: "Quota de stockage du navigateur d\xE9pass\xE9. Les modifications ne seront pas enregistr\xE9es."
};
var errors = {
  ...
  saveLibraryError: "Impossible d'enregistrer la biblioth\xE8que sur le stockage. Veuillez enregistrer votre biblioth\xE8que dans un fichier localement pour \xE9viter de perdre vos modifications.",
  ...
  libraryElementTypeError: {
    ...
    iframe: "Les \xE9l\xE9ments IFrame ne peuvent pas \xEAtre ajout\xE9s \xE0 la biblioth\xE8que.",
...
var toolBar = {
  ...
  link: "Ajouter / Mettre \xE0 jour un lien pour une forme s\xE9lectionn\xE9e",
  eraser: "Gomme",
  frame: "Outil de cadre",
  magicframe: "Mod\xE8le en fil de fer vers code",
...
var hints = {
  ...
  canvasPanning: "Pour d\xE9placer le canevas, maintenez {{shortcut_1}} ou {{shortcut_2}} enfonc\xE9 tout en faisant glisser, ou utilisez l'outil main",
  linearElement: "Cliquez pour d\xE9marrer plusieurs points, faites glisser pour une seule ligne",
  arrowTool: "Cliquez pour d\xE9marrer plusieurs points, faites glisser pour une ligne unique. Appuyez \xE0 nouveau sur {{shortcut}} pour changer le type de fl\xE8che.",
  ...
  lockAngle: "Vous pouvez limiter l'angle en maintenant la touche {{shortcut}} enfonc\xE9e",
  resize: "Vous pouvez contraindre les proportions en maintenant {{shortcut_1}} pendant le redimensionnement,\nmaintenez {{shortcut_2}} enfonc\xE9 pour redimensionner depuis le centre",
  resizeImage: "Vous pouvez redimensionner librement en maintenant {{shortcut_1}},\nmaintenez {{shortcut_2}} enfonc\xE9 pour redimensionner depuis le centre",
  rotate: "Vous pouvez contraindre les angles en maintenant {{shortcut}} enfonc\xE9 pendant la rotation",
  ...
  lineEditor_pointSelected: "Appuyez sur {{shortcut_1}} pour supprimer le(s) point(s),\n{{shortcut_2}} pour dupliquer, ou faites glisser pour d\xE9placer",
  lineEditor_nothingSelected: "S\xE9lectionnez un point \xE0 \xE9diter (maintenez {{shortcut_1}} enfonc\xE9 pour en s\xE9lectionner plusieurs),\nou maintenez {{shortcut_2}} et cliquez pour ajouter de nouveaux points",
  publishLibrary: "Publier votre propre biblioth\xE8que",
  bindTextToElement: "{{shortcut}} pour ajouter du texte",
  createFlowchart: "{{shortcut}} pour cr\xE9er un diagramme",
  deepBoxSelect: "Maintenez {{shortcut}} enfonc\xE9 pour s\xE9lectionner en profondeur, et pour \xE9viter le glissement",
  eraserRevert: "Maintenez {{shortcut}} pour annuler les \xE9l\xE9ments marqu\xE9s pour suppression",
  ...
  disableSnapping: "Maintenez {{shortcut}} pour d\xE9sactiver l'accrochage",
  enterCropEditor: "Double-cliquez sur l'image ou appuyez sur {{shortcut}} pour recadrer l'image",
  leaveCropEditor: "Cliquez \xE0 l'ext\xE9rieur de l'image ou appuyez sur {{shortcut_1}} ou {{shortcut_2}} pour terminer le recadrage"
};
var canvasError = {
...
var roomDialog = {
  desc_intro: "Invitez des personnes \xE0 collaborer sur votre dessin.",
  desc_privacy: "Ne vous inqui\xE9tez pas, la session est chiffr\xE9e de bout en bout et enti\xE8rement priv\xE9e. M\xEAme notre serveur ne peut pas voir ce que vous dessinez.",
...
var helpDialog = {
  ...
  createFlowchart: "Cr\xE9er un diagramme \xE0 partir d'un \xE9l\xE9ment",
  navigateFlowchart: "",
...
var stats = {
  ...
  storage: "Stockage",
  fullTitle: "Propri\xE9t\xE9s du canevas et des formes",
  title: "Propri\xE9t\xE9s",
  generalStats: "G\xE9n\xE9ral",
  elementProperties: "Propri\xE9t\xE9s de la forme",
  total: "Total",
  version: "Version",
...
var toast = {
  ...
  copyToClipboardAsSvg: "{{exportSelection}} copi\xE9 dans le presse-papier en SVG\n({{exportColorScheme}})",
  ...
  elementLinkCopied: "Lien copi\xE9 dans le presse-papiers"
};
var colors = {
...
var fontList = {
  ...
  sceneFonts: "Dans cette sc\xE8ne",
  availableFonts: "Polices disponibles",
  empty: "Aucune police trouv\xE9e"
};
var userList = {
  empty: "Aucun utilisateurs trouv\xE9",
  hint: {
...
var commandPalette = {
  ...
  recents: "R\xE9cemment utilis\xE9",
  search: {
    placeholder: "Recherchez dans les menus, les commandes et d\xE9couvrez des gemmes cach\xE9es",
...
//# sourceMappingURL=fr-FR-KCXBY2R4.js.map
