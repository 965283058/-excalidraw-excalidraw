...
var labels = {
  ...
  copySource: "Copiar fonte para \xE1rea de transfer\xEAncia",
  ...
  arrowhead_crowfoot_many: "P\xE9 de p\xE1ssaro (muitos)",
  arrowhead_crowfoot_one: "P\xE9 de p\xE1ssaro (um)",
  arrowhead_crowfoot_one_or_many: "P\xE9 de p\xE1ssaro (um ou muitos)",
  more_options: "Mais op\xE7\xF5es",
  arrowtypes: "Tipo de seta",
  arrowtype_sharp: "Seta afiada",
  arrowtype_round: "Seta curva",
  arrowtype_elbowed: "Seta dobrada",
  ...
  loadScene: "Carregar cen\xE1rio de arquivo",
  align: "Alinhamento",
  ...
  showFonts: "Exibir seletor de fonte",
  ...
  link: {
    edit: "Editar link",
    editEmbed: "Editar link incorpor\xE1vel",
    create: "Adicionar link",
    label: "Link",
  ...
  followUs: "Siga-nos",
  discordChat: "Discord",
  zoomToFitViewport: "Zoom para caber na tela",
  zoomToFitSelection: "Ampliar para ajustar a sele\xE7\xE3o",
  zoomToFit: "Ampliar para encaixar todos os elementos",
  installPWA: "Instalar excalidraw localmente (PWA)",
  autoResize: "Habilitar redimensionamento autom\xE1tico de texto",
  imageCropping: "Recorte de imagem",
  unCroppedDimension: "Dimens\xE3o sem recortes",
  copyElementLink: "Copiar link para o objeto",
  linkToElement: "Links para o objeto",
  wrapSelectionInFrame: "Ajustar sele\xE7\xE3o no frame",
  tab: "",
  shapeSwitch: ""
};
var elementLink = {
  ...
  notFound: "Objeto vinculado n\xE3o foi encontrado na tela."
};
var library = {
...
var alerts = {
  ...
  cannotExportEmptyCanvas: "N\xE3o \xE9 poss\xEDvel exportar uma tela vazia.",
...
var errors = {
  ...
  saveLibraryError: "N\xE3o foi poss\xEDvel salvar a biblioteca no armazenamento. Salve sua biblioteca em um arquivo localmente para garantir que voc\xEA n\xE3o perca as altera\xE7\xF5es.",
  ...
  imageToolNotSupported: "Imagens est\xE3o desabilitadas.",
  ...
  libraryElementTypeError: {
    embeddable: "Elementos incorpor\xE1veis n\xE3o podem ser adicionados \xE0 biblioteca.",
    iframe: "Elementos do IFrame n\xE3o podem ser adicionados \xE0 biblioteca.",
    image: "Suporte para adicionar imagens \xE0 biblioteca em breve!"
  },
...
var toolBar = {
  ...
  embeddable: "P\xE1gina web incorporada",
  laser: "Ponteiro de laser",
...
var hints = {
  ...
  embeddable: "Clique e arraste para criar um site incorporado",
  text_selected: "",
  text_editing: "",
  linearElementMulti: "",
  lockAngle: "",
...
var roomDialog = {
  desc_intro: "Convide pessoas para colaborar em seu desenho.",
  desc_privacy: "N\xE3o se preocupe, a sess\xE3o \xE9 criptografada de ponta a ponta e totalmente privada. Nem mesmo nosso servidor pode ver o que voc\xEA desenha.",
...
var exportDialog = {
  ...
  link_details: "Exportar como link de somente leitura.",
...
var helpDialog = {
  ...
  createFlowchart: "Crie um fluxograma a partir de um elemento gen\xE9rico",
  navigateFlowchart: "Navegar por um fluxograma",
...
var publishDialog = {
  ...
  placeholder: {
    ...
    libraryDesc: "Descri\xE7\xE3o para ajudar as pessoas a entenderem o uso da sua biblioteca",
...
var stats = {
  ...
  fullTitle: "Propriedades da Tela e da Forma",
  title: "Propriedades",
  generalStats: "Geral",
...
var toast = {
  ...
  copyToClipboardAsSvg: "Copiado {{exportSelection}} para a \xE1rea de transfer\xEAncia com SVG ({{exportColorScheme}})",
  ...
  unableToEmbed: "No momento n\xE3o \xE9 permitido incorporar esta URL. Crie uma issue no GitHub para solicitar a lista branca da URL",
  unrecognizedLinkFormat: "O link incorporado n\xE3o corresponde ao formato esperado. Por favor, tente colar a string 'incorporada' que foi fornecida pelo site de origem",
  elementLinkCopied: ""
};
var colors = {
...
var mermaid = {
  ...
  button: "Inserir",
  description: "Atualmente apenas os diagramas<flowchartLink>Flowchart</flowchartLink><sequenceLink>Sequ\xEAncia,</sequenceLink> e <classLink>Class</classLink>s\xE3o suportados. Os outros tipos ser\xE3o renderizados como uma imagem no Excalidraw.",
  syntax: "Sintaxe em Mermaid",
  preview: "Visualizar"
};
var quickSearch = {
  placeholder: "Busca r\xE1pida"
};
var fontList = {
  badge: {
    old: "antigo"
  },
  sceneFonts: "Neste cen\xE1rio",
  availableFonts: "Fontes dispon\xEDveis",
  empty: "Nenhuma fonte encontrada"
};
var userList = {
  empty: "Nenhum usu\xE1rio encontrado",
  hint: {
    text: "Clique no usu\xE1rio para seguir",
    followStatus: "Atualmente voc\xEA est\xE1 seguindo este usu\xE1rio",
    inCall: "O usu\xE1rio est\xE1 em uma chamada de voz",
    micMuted: "O microfone do usu\xE1rio est\xE1 silenciado",
    isSpeaking: "O usu\xE1rio est\xE1 falando"
  }
};
var commandPalette = {
  ...
  search: {
    placeholder: "Procure menus, comandos e descubra gemas ocultas",
    noMatch: "Nenhum comando correspondente..."
  },
  itemNotAvailable: "Comando indispon\xEDvel...",
...
//# sourceMappingURL=pt-BR-ERVIQI63.js.map
