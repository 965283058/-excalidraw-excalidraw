...
var labels = {
  ...
  stroke: "Poteza",
  changeStroke: "Spremeni barvo poteze",
  background: "Ozadje",
  changeBackground: "Spremeni barvo ozadja",
  fill: "Polnilo",
  ...
  arrowtype_elbowed: "Pu\u0161\u010Dica tipa komolca",
  ...
  loadScene: "Nalo\u017Ei sceno iz datoteke",
  align: "Poravnava",
  ...
  showFonts: "Poka\u017Ei izbirnik pisave",
  toggleTheme: "Preklapljanje med svetlo/temno temo",
  theme: "Tema",
  ...
  link: {
    edit: "Uredi povezavo",
    editEmbed: "Uredi vdelano povezavo",
    create: "Dodaj povezavo",
    label: "Povezava",
    labelEmbed: "Povezava in vdelovanje",
    empty: "Povezava ni nastavljena",
    hint: "Tukaj vnesite ali prilepite svojo povezavo",
    goToElement: "Pojdite na ciljni element"
  },
  lineEditor: {
    edit: "Uredi \u010Drto",
    editArrow: "Uredi pu\u0161\u010Dico"
  },
  polygon: {
    breakPolygon: "",
    convertToPolygon: ""
  ...
  prompt: "Poziv",
  followUs: "Sledi nas",
  discordChat: "Klepet v Discordu",
  zoomToFitViewport: "Pribli\u017Eaj na vidno polje",
  zoomToFitSelection: "Pribli\u017Eaj na izbor",
  zoomToFit: "Pribli\u017Eaj na vse elemente",
  installPWA: "Namesti Excalidraw lokalno (PWA)",
  autoResize: "Omogo\u010Di samodejno spreminjanje velikosti besedila",
  imageCropping: "Obrezovanje slike",
  unCroppedDimension: "Neobrezana dimenzija",
  copyElementLink: "Kopiraj povezavo do objekta",
...
var elementLink = {
  ...
  desc: "Kliknite obliko na platnu ali prilepite povezavo.",
  notFound: "Objekta s povezave ni bilo mogo\u010De najti na platnu."
};
var library = {
...
var search = {
  ...
  placeholder: "Poi\u0161\u010Di besedilo na platnu ...",
  frames: "",
  texts: ""
};
var buttons = {
...
var helpDialog = {
  ...
  cropStart: "Obre\u017Ei sliko",
  cropFinish: "Dokon\u010Daj obrezovanje slike"
};
...
var stats = {
  ...
  selected: "Izbrano",
  storage: "Shramba",
  fullTitle: "Lastnosti platna in oblike",
  title: "Lastnosti",
  generalStats: "Splo\u0161no",
  elementProperties: "Lastnosti oblike",
  total: "Skupaj",
  version: "Razli\u010Dica",
...
var toast = {
  ...
  copyToClipboardAsSvg: "Kopirano v odlo\u017Ei\u0161\u010De kot SVG ({{exportSelection}}, {{exportColorScheme}})",
  ...
  elementLinkCopied: "Povezava kopirana na odlo\u017Ei\u0161\u010De"
};
var colors = {
...
var quickSearch = {
  placeholder: "Hitro iskanje"
};
var fontList = {
  badge: {
    old: "stara"
  },
  sceneFonts: "V tej sceni",
  availableFonts: "Razpolo\u017Eljive pisave",
  empty: "Ni pisav"
};
var userList = {
  empty: "Ni uporabnikov",
  hint: {
    text: "Klikni na uporabnika za sledenje",
    followStatus: "Trenutno sledi\u0161 temu uporabniku",
    inCall: "Uporabnik je v glasovnem klicu",
    micMuted: "Uporabnikov mikrofon je izklopljen",
    isSpeaking: "Uporabnik govori"
  }
};
var commandPalette = {
  title: "Paleta ukazov",
  ...
  recents: "Nedavno uporabljeno",
  search: {
    placeholder: "I\u0161\u010Di po menijih, ukazih in odkrij skrite funkcije",
    noMatch: "Ni ustreznih ukazov ..."
  },
  itemNotAvailable: "Ukaz ni na voljo ...",
  shortcutHint: "Za paleto ukazov uporabi {{shortcut}}"
};
var keys = {
  ctrl: "",
  option: "",
...
//# sourceMappingURL=sl-SI-4PJ6LBI7.js.map
