...
var labels = {
  ...
  changeStroke: "Canvia el color del tra\xE7",
  ...
  arrowhead_circle_outline: "Circumfer\xE8ncia",
  ...
  clearCanvas: "Neteja el llen\xE7",
  layers: "Capes",
  actions: "Accions",
  language: "Llengua",
  ...
  toggleGrid: "Alterna la quadr\xEDcula",
  ...
  showFonts: "Mostra el selector tipogr\xE0fic",
  ...
  link: {
    ...
    editEmbed: "Editar enlla\xE7 incrustable",
    create: "Afegir un enlla\xE7",
    label: "Enlla\xE7",
    labelEmbed: "Enlla\xE7a i encasta",
    empty: "No s'ha definit cap enlla\xE7",
    hint: "Escriu o enganxa un enlla\xE7 aqu\xED",
  ...
  eyeDropper: "Tria un color del llen\xE7",
  textToDiagram: "Text a diagrama",
  prompt: "Prompt",
  followUs: "Seguiu-nos",
  discordChat: "Xat de Discord",
  zoomToFitViewport: "Amplia per adaptar-se a la finestra",
  zoomToFitSelection: "Zoom per veure la selecci\xF3",
  zoomToFit: "Zoom per veure tots els elements",
  installPWA: "Instal\xB7la Excalidraw localment (PWA)",
  autoResize: "Activa la redimensi\xF3 de text autom\xE0tica",
  imageCropping: "Retallar la imatge",
  unCroppedDimension: "Dimensi\xF3 sense retallar",
  copyElementLink: "Copiar enlla\xE7 a objecte",
  linkToElement: "Enlla\xE7 a l'objecte",
  wrapSelectionInFrame: "Embolica la selecci\xF3 en un marc",
  tab: "",
  shapeSwitch: ""
};
var elementLink = {
  title: "Enlla\xE7 a l'objecte",
  desc: "Fes clic en una forma al llen\xE7 o enganxa un enlla\xE7.",
  notFound: "L'objecte enlla\xE7at no s'ha trobat al llen\xE7."
};
var library = {
...
var search = {
  title: "Troba al llen\xE7",
  noMatch: "No hem trobat coincid\xE8ncies...",
  singleResult: "resultat",
  multipleResults: "resultats",
  placeholder: "Troba al llen\xE7...",
  frames: "",
  texts: ""
};
var buttons = {
...
var errors = {
  ...
  brave_measure_text_error: {
    line1: "Sembla que feu servir el navegador Brave amb el <bold>blocatge agressiu d'indentificaci\xF3 \xFAnica</bold> activat.",
    line2: "Aix\xF2 podria provocar problemes amb els <bold>elements de text</bold> en els vostres dissenys.",
    line3: "Us recomanem encaridament que desactiveu aquesta caracter\xEDstica. Podeu seguir <link>aquests passos</link> per a fer-ho.",
    line4: "Si els elements de text no es mostren correctament malgrat haver desactivat aquesta opci\xF3, si us plau, obriu una <issueLink>incid\xE8ncia</issueLink> a la nostra p\xE0gina de GitHub o escriviu-nos a <discordLink>Discord</discordLink>"
  },
...
var toolBar = {
  ...
  link: "Afegeix/actualitza l'enlla\xE7 per a una forma seleccionada",
  eraser: "Esborrador",
  frame: "Eina de marc",
  magicframe: "De Wireframe a codi",
  embeddable: "Incrustaci\xF3 Web",
  laser: "Punter l\xE0ser",
  hand: "M\xE0 (eina de despla\xE7ament)",
  extraTools: "M\xE9s eines",
...
var element = {
  ...
  arrow: "Fletxa",
  line: "L\xEDnia",
  freedraw: "Dibuix a m\xE0 al\xE7ada",
  text: "Text",
  image: "Imatge",
  group: "Grup",
  frame: "Marc",
...
var hints = {
  ...
  embeddable: "Feu clic i arrossegueu per crear una Incrustaci\xF3 Web",
  text_selected: "",
  text_editing: "",
  linearElementMulti: "",
  lockAngle: "",
...
var roomDialog = {
  desc_intro: "Convideu gent a col\xB7laborar en el vostre disseny.",
  desc_privacy: "No us amo\xEFneu, la sessi\xF3 est\xE0 encriptada d'extrem a extrem i \xE9s totalment privada. Ni tan sols el nostre servidor pot veure qu\xE8 dibuixeu.",
...
var helpDialog = {
  ...
  createFlowchart: "Crear un diagrama de flux a partir d'un element gen\xE8ric",
  ...
  drag: "arrossega",
  editor: "Editor",
  editLineArrowPoints: "Edita els punts de la l\xEDnia/fletxa",
...
var imageExportDialog = {
  ...
  label: {
    withBackground: "Fons",
    onlySelected: "Nom\xE9s seleccionat",
    darkMode: "Mode fosc",
...
var stats = {
  ...
  fullTitle: "Propietats del Llen\xE7 i de la Forma",
  title: "Propietats",
...
var toast = {
  ...
  unableToEmbed: "Actualment no es permet incrustar aquesta URL. Planteja un problema a GitHub per sol\xB7licitar que l'URL estigui a la llista blanca",
  unrecognizedLinkFormat: "L'enlla\xE7 que has incrustat no coincideix amb el format esperat. Si us plau, intenta enganxar l'enlla\xE7 'embed' proporcionada pel lloc web d'origen",
  elementLinkCopied: "Enlla\xE7 copiat al porta-retalls"
};
var colors = {
...
var colorPicker = {
  color: "",
  mostUsedCustomColors: "Colors personalitzats m\xE9s usats",
  colors: "Colors",
  shades: "Ombres",
...
var overwriteConfirm = {
  action: {
    exportToImage: {
      ...
      description: "Exporta les dades de l'escena com una imatge des de la qual podr\xE0s importar-les m\xE9s tard."
    },
    saveToDisk: {
      title: "Deseu al disc",
      button: "Deseu al disc",
      description: "Exporta les dades de l'escena a un fitxer des del qual podr\xE0s importar-les m\xE9s tard."
    },
    excalidrawPlus: {
      title: "Excalidraw+",
  ...
  modal: {
    loadFromFile: {
      ...
      description: "Carregar des d'un fitxer <bold>substituir\xE0 el contingut actual</bold>.<br></br>Podeu desar el vostre disseny abans fent servir una de les opcions m\xE9s avall."
    },
    shareableLink: {
      title: "Carrega des d'un enlla\xE7",
      button: "Substitueix el contingut",
      description: "Carregar un disseny extern <bold>substituir\xE0 el contingut actual</bold>.<br></br>Podeu desar el vostre disseny abans fent servir una de les opcions m\xE9s avall."
    }
  }
};
var mermaid = {
  ...
  button: "Inseriu",
  description: "Actualment nom\xE9s s'admeten els diagrames <flowchartLink>Flowchart</flowchartLink>, <sequenceLink> Sequence, </sequenceLink> i <classLink> Class </classLink>. Els altres tipus es representaran com a imatge a Excalidraw.",
  syntax: "Sintaxi de Mermaid",
  preview: "Previsualitzaci\xF3"
};
var quickSearch = {
  placeholder: "Cerca r\xE0pida"
};
var fontList = {
  badge: {
    old: "antic"
  ...
  availableFonts: "Lletres tipogr\xE0fiques disponibles",
  empty: "No s'ha trobat cap lletra tipogr\xE0fica"
};
var userList = {
  ...
  hint: {
    ...
    micMuted: "El micr\xF2fon de l'usuari \xE9s silenciat",
...
var commandPalette = {
  ...
  search: {
    placeholder: "Cerca men\xFAs, ordres i descobreix joies amagades",
...
//# sourceMappingURL=ca-ES-73KY52DM.js.map
